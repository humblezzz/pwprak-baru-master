...
@section('contentclass', 'adm-full adm-absensi')

@section('content')
    <div class="adm-full__absolute">
        <div class="content adm-full__search-div">
            <input type="text" class="adm-dashboard__input-search" id="adm-absensi-search" placeholder="Search"
                style="">
        </div>
                    ...
                    <tr>
                        ...
                        @foreach ($jadwal as $joy)
                            <th><span>
                                    ...
                                    <span
                                        class="malachite">{{ explode(' ', $joy[0])[1] }}-{{ explode(' ', $joy[1])[1] }}</span>
                                </span>
                            </th>
                            @php
                                if ($sess == 1) {
